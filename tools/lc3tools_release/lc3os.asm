...
OS_START_MSG	.STRINGZ "\nWelcome to the LC-3 simulator.\n\nThe contents of the LC-3 tools distribution, including sources, management\ntools, and data, are Copyright (c) 2003-2021 Steven S. Lumetta, LIU Tingkai,\nLUO Wenqing.\n\nThe LC-3 tools distribution is free software covered by the NCSA Open\nSource License, and you are welcome to modify it and/or distribute copies\nof it under certain conditions. The file LICENSE (distributed with the\ntools) specifies those conditions. There is absolutely no warranty for\nthe LC-3 tools distribution.\n\nHave fun.\n"
