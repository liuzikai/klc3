; This program have an HALT in a subroutine
; KLC3 is expected to detect and give warning of WARN_HALT_IN_SUBROUTINE
...
; CHECK-NOT: RET to main code
; CHECK: ================ END OF TEST CASE 0 OUT ================

; CHECK: ================ REPORT ================
; CHECK-NEXT: WARN_HALT_IN_SUBROUTINE
...
; RUN: %klc3 %s --use-forked-solver=false --report-to-terminal=true --lc3-out-to-terminal=true --output-dir=none 2>&1 | FileCheck %s